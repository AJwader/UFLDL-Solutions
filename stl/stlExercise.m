...
params.epsilon = 1e-2;   
params.m= 200000;  %num of patches
%% ======================================================================
...
patches = samplePatches([unlabeledData,trainData],params.patchWidth,params.m);
...
randTheta2 = randTheta2';      %Input dimension by num_classes matrix.
...
tic;
randTheta2(:)=minFunc(@softmax_regression_vec, randTheta2(:), options, trainFeatures, trainLabels);
...
%%We use multi_clasifier_accuracy function here for accuracy computation.
  
  %print out train accuracy.
  accuracy = multi_classifier_accuracy(randTheta2,trainFeatures,trainLabels);
  fprintf('Training accuracy: %2.1f%%\n', 100*accuracy);

              
  % Print out test accuracy.
  accuracy = multi_classifier_accuracy(randTheta2,testFeatures,testLabels);
